    ...
    MenuBar {
        ...
        if (viewModel.useEditorMenu()) {
            Menu("Edit") {
                ...
                Item(
                    "Save",
                    shortcut = KeyShortcut(Key.S, ctrl = !viewModel.useMetaKey(), meta = viewModel.useMetaKey()),
        ...
        Menu("Tab") {
            ...
            if (viewModel.canMoveTab()) {
                Item(
                    ...
                    shortcut = KeyShortcut(Key.PageUp, ctrl = true),
                    onClick = viewModel::movePreviousTab
                )

                Item(
                    "Move next tab",
                    icon = painterResource(Res.drawable.ic_forward),
                    shortcut = KeyShortcut(Key.PageDown, ctrl = true),
                    onClick = viewModel::moveNextTab
                )
            }
        ...
        Menu("Window") {
            ...
            Item(
                "Use background",
                shortcut = KeyShortcut(key = Key.B, alt = true),
